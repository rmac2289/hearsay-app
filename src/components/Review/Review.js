...
export default function Review(props) {
  ...
  const reviewsList = props.reviews
    ...
    .map((value, index) => {
      ...
      return (
        <section key={index} className="reviewSection">
          <p>
          ...
          <p>
            <strong>Nature of Encounter:</strong> {value.nature}
          </p>
          <p>
  ...
  return (
    <div>
      ...
      <div className="write">
        <div id="write" onClick={scrollDown}>
          write review
        </div>
      </div>
      ...
      {reviewsList.length > 0 ? (
        ...
        <section id="nobody">
          <h3>Looks like nobody has reviewed this agency yet!</h3>
        </section>
      )}
      <div id="Review"></div>
    </div>
